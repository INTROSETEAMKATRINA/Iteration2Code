			...
			if(rs.first()){
				...
				do{
					...
					if(rs2.next()){
						...
						RDW += rs2.getFloat("RDW"); DailyRate += rs2.getFloat("DailyRate");
						TranspoAllow += rs2.getFloat("TranspoAllow");
						RegularPay += rs2.getFloat("RegularPay"); ROT += rs2.getFloat("ROT");
						ROTPay += rs2.getFloat("ROTPay"); RNSD += rs2.getFloat("RNSD");
						RNSDPay += rs2.getFloat("RNSDPay"); LH += rs2.getFloat("LH"); 
						LHPay += rs2.getFloat("LHPay"); LHOT += rs2.getFloat("LHOT");
						LHOTPay += rs2.getFloat("LHOTPay"); LHNSD += rs2.getFloat("LHNSD");
						LHNSDPay += rs2.getFloat("LHNSDPay"); SH += rs2.getFloat("SH"); 
						SHPay += rs2.getFloat("SHPay");
						SHOT += rs2.getFloat("SHOT"); SHOTPay += rs2.getFloat("SHOTPay"); 
						SHNSD += rs2.getFloat("SHNSD"); SHNSDPay += rs2.getFloat("SHNSDPay");
						Adjustments += rs2.getFloat("Adjustments"); GrossPay += rs2.getFloat("GrossPay"); 
						SSS += rs2.getFloat("SSS"); PHIC += rs2.getFloat("PHIC");
						HDMF += rs2.getFloat("HDMF"); SSSLoan += rs2.getFloat("SSSLoan"); 
						PayrollAdvance += rs2.getFloat("PayrollAdvance"); 
						HouseRental += rs2.getFloat("HouseRental");
						UniformAndOthers += rs2.getFloat("UniformAndOthers"); 
						Savings += rs2.getFloat("Savings"); NetPay += rs2.getFloat("NetPay");
						LHRD += rs2.getFloat("LHRD");
						SHRD += rs2.getFloat("SHRD");
						TRDW += rs2.getFloat("RDW"); TranspoAllow += rs2.getFloat("TranspoAllow");
						TRegularPay += rs2.getFloat("RegularPay"); TROT += rs2.getFloat("ROT"); 
						TROTPay += rs2.getFloat("ROTPay"); TRNSD += rs2.getFloat("RNSD");
						TRNSDPay += rs2.getFloat("RNSDPay"); TLH += rs2.getFloat("LH"); 
						TLHPay += rs2.getFloat("LHPay"); TLHOT += rs2.getFloat("LHOT");
						TLHOTPay += rs2.getFloat("LHOTPay"); TLHNSD += rs2.getFloat("LHNSD");
						TLHNSDPay += rs2.getFloat("LHNSDPay"); TSH += rs2.getFloat("SH"); 
						TSHPay += rs2.getFloat("SHPay");
						TSHOT += rs2.getFloat("SHOT"); TSHOTPay += rs2.getFloat("SHOTPay"); 
						TSHNSD += rs2.getFloat("SHNSD"); TSHNSDPay += rs2.getFloat("SHNSDPay");
						TAdjustments += rs2.getFloat("Adjustments"); 
						TGrossPay += rs2.getFloat("GrossPay");
						TSSS += rs2.getFloat("SSS"); TPHIC += rs2.getFloat("PHIC");
						THDMF += rs2.getFloat("HDMF"); TSSSLoan += rs2.getFloat("SSSLoan");
						TPayrollAdvance += rs2.getFloat("PayrollAdvance"); 
						THouseRental += rs2.getFloat("HouseRental");
						TUniformAndOthers += rs2.getFloat("UniformAndOthers"); 
						TSavings += rs2.getFloat("Savings"); TNetPay += rs2.getFloat("NetPay");
						TLHRD += rs2.getFloat("LHRD");
						TSHRD += rs2.getFloat("SHRD"); 
		    	 	}
